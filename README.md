...
---
## 활용된 오프소스 라이브러리
이 프로젝트는 여러 오픈소스 라이브러리를 활용함으로써 개발될 수 있었습니다.
...
4. Pinecone 인덱스 생성
   ...
   현재 프로젝트는 cosine Metric, 3072 Dementions로 인덱스를 설정하였습니다.<br/>
...
### HuggingFace 허브 업로드
파인튜닝된 모델은 HuggingFace 허브에 업로드하여 로컬 환경 설정 없이 간편히 사용할 수 있도록 하였습니다.<br/>
